define(function (require) {
  ...
  $("#moduleSelected").click(function () {
    ...
    projectNavigationBar.sendMessage('ModuleSelected', {
      id: moduleId
    });
  });
  ...
  $("#modelToggled").click(function () {
    ...
    if (selectValue !== "") {
      projectNavigationBar.sendMessage('ModelToggled', {
        id: modelId,
        selected: selectValue === "true" ? true : false
      });
    } else {
      projectNavigationBar.sendMessage('ModelToggled', {
        id: modelId
  ...
  $("#modelLayerToggled").click(function () {
    ...
    if (selectValue !== "") {
      projectNavigationBar.sendMessage('ModelLayerToggled', {
        modelId: _modelId,
        modelLayerId: _modelLayerId,
        selected: selectValue === "true" ? true : false
      });
    } else {
      projectNavigationBar.sendMessage('ModelLayerToggled', {
  ...
  $("#topologyNodeToggled").click(function () {
    ...
    if (selectValue !== "") {
      projectNavigationBar.sendMessage('TopologyNodeToggled', {
        id: topologyNodeId,
        selected: selectValue === "true" ? true : false
      });
    } else {
  ...
  $("#modelTransparencyToggled").click(function () {
    ...
    if (selectValue !== "") {
      projectNavigationBar.sendMessage('ModelTransparencyToggled', {
        id: modelId,
        selected: selectValue === "true" ? true : false
      });
    } else {
  ...
  $("#modelLayerTransparencyToggled").click(function () {
    ...
    if (selectValue !== "") {
      projectNavigationBar.sendMessage('ModelLayerTransparencyToggled', {
        modelId: _modelId,
        modelLayerId: _modelLayerId,
        selected: selectValue === "true" ? true : false
      });
  ...
  $("#structureSelected").click(function () {
    ...
    projectNavigationBar.sendMessage('StructureSelected', {
      id: structureSelectedId
    });
  });

  $("#structureNodeSelected").click(function () {
    let structureNodeSelectedId = $("#structureNodeSelectedId").val();
    projectNavigationBar.sendMessage('StructureNodeSelected', {
      id: structureNodeSelectedId
    });
  });
  ...
  $("#structureNodeToggled").click(function () {
    ...
    if (selectValue !== "") {
      projectNavigationBar.sendMessage('StructureNodeToggled', {
        id: structureNodeId,
        selected: selectValue === "true" ? true : false
      });
    } else {
  ...
  $("#filterSelected").click(function () {
    ...
    projectNavigationBar.sendMessage('FiletrSelected', {
      id: filterSelectedUUID,
      disciplineId: disciplineUUID
    });
  });
  ...
  $("#filterNodeSelected").click(function () {
    ...
    if (selectValue !== "") {
      projectNavigationBar.sendMessage('FilterNodeSelected', {
        id: filterNodeSelectedUUID,
        disciplineId: disciplineUUID,
        selected: selectValue === "true" ? true : false
      });
    } else {
  ...
  $("#filterNodeToggled").click(function () {
    ...
    if (selectValue !== "") {
      projectNavigationBar.sendMessage('FilterNodeToggled', {
        id: filterNodeToggledUUID,
        disciplineId: disciplineUUID,
        selected: selectValue === "true" ? true : false
      });
    } else {
